...
class Triangle extends Shapes {
    ...
    render() {
        return `
        <svg height="300" width="200" xmlns="http://www.w3.org/2000/svg">
        <polygon points="200,10 250,190 160,210" style="fill:${this.shapeColor};stroke:black;stroke-width:1" />
        <text x="94%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
        </svg>`;
    }
};
...
class Square extends Shapes {
    ...
    render () {
        ...
        <text x="50%" y="25%" dominant-baseline="middle" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
        </svg>`;
    }
};
